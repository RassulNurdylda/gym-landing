export const Info = () => {
  return (
    <div className="w-full relative">
      <div className=" bg-redik  md:h-1 pt-5"></div>
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-8 text-white ">
          <div className="md:p-24 p-8 lg:mt-24">
            ...
            <p className="md:text-2xl text-xl font-medium mt-10">
              В спортивном клубе «KUSH» — физические занятия обязательно изменят
              вашу жизнь к лучшему. Вы имеете прекрасную возможность улучшить
              физическую форму, сбросить лишний вес, придайте больше
              выносливости своим мышцам, сформировать такое тело, о котором вы
              всегда мечтали. Это придаст большой толчок вашей самооценке и вере
              в свои силы.
            </p>
          </div>
          <div className=" ">
            <img
              src="kacok.png"
              className="lg:mt-44 xl:mt-10 xl:pl-52  2xl:mt-1 md:pl-20"
            />
          </div>
        </div>
      </div>
